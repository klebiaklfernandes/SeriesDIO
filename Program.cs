...
namespace DIO.Series
{
	class Program
	{
        ...
        private static string GotoMoviesMethods()
        {
			Console.Clear();

			string opcaoUsuario = ObterOpcaoFilmeUsuario();
			...
			while (opcaoUsuario.ToUpper() != "X")
            {
                ...
                opcaoUsuario = ObterOpcaoFilmeUsuario();
            }

            return opcaoUsuario;
        }

        private static string GotoSeriesMethods()
        {
			Console.Clear();

			string opcaoUsuario = ObterOpcaoSerieUsuario();
			...
			while (opcaoUsuario.ToUpper() != "X")
            {
                ...
                opcaoUsuario = ObterOpcaoSerieUsuario();
            }
		...
		private static string ObterOpcaoUsuario()
		{
			...
			Console.WriteLine("1- Ir para Séries");
			Console.WriteLine("2- Ir para Filmes");
